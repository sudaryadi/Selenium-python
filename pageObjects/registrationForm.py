...
class Registration:
    menu_forms_class = "card-up"
    submenu_practiceForm_class = "btn btn-light "
    txt_firstName_id = "firstName"
    txt_lastName_id = "lastName"
    txt_email_id = "userEmail"
    radio_male_id = "gender-radio-1"
    ...
    def select_forms(self):
        self.driver.find_element(By.ID, self.menu_forms_class).click()

    def select_practice_form(self):
        self.driver.find_element(By.ID, self.submenu_practiceForm_class).click()
    ...
    def input_phone_number(self, mobile):
        self.driver.find_element(By.ID, self.input_phone_number).send_keys(mobile)
    ...
    def select_city(self):
        ...
        self.driver.find_element(By.ID, self.item_jaipur_xpath).click()
